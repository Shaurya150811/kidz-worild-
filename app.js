...
​
    var book1CostInCents = book1.quantity * book1.dollars * 100 + book1.quantity * book1.cents;
    
    var book2CostInCents = book2.quantity * book2.dollars * 100 + book2.quantity * book2.cents;
